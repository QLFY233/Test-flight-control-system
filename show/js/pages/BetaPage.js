 ...
 * Right panel: view area with 1/2 view mode selector
...
class BetaPage {
    ...
    render() {
        ...
        // View mode selector (1/2 views only)
    ...
    _setupViews(viewArea) {
        ...
        const mode = Math.min(ui.viewMode || 1, 2);
        ...
        else viewArea.classList.add('right-column__view-area--double');
